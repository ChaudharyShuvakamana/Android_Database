...
public class EditDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(np.com.manishbista.database.R.layout.activity_edit_details);
        ...
        btnUpdate = findViewById(np.com.manishbista.database.R.id.btnUpdate);
        btnGoBack = findViewById(np.com.manishbista.database.R.id.btnBack);
